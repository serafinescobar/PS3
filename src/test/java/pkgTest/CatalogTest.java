...
public class CatalogTest {
	...
	public void TestGetBook2() throws BookException {
		...
		assertTrue(Catalog.GetBook(cat,"bk104").equals(cat.getBooks().get(1)));
	...
	public void TestGetBook3() throws BookException {
		...
		assertTrue(Catalog.GetBook(cat,"bk011").equals(cat.getBooks().get(0)));
	...
	public void TestAddBook1() throws BookException {
		...
		Book testbook = new Book("bk113", "Serafin the Great", "The Legend", "NonFiction", 80.00, new Date(), "Jon's Memoir", 40.00);
	...
	public void TestAddBook2() throws BookException {
		...
		Book testbook2 = new Book("bk101", "PS3", "Horrors of XML", "Thriller", 40.00, new Date(), "Be Ware of the xml files", 24.00);
